...
account_urlpatterns = [
    ...
    path('account/sign-up-done/', TemplateView.as_view(template_name='account/signup_done.html'),
    ...
    path('account/password/recover-done/', TemplateView.as_view(
        template_name='account/password/recover_done.html'), name='account_password_recover_done'),
    ...
    path('account/password/reset-confirm-done/', TemplateView.as_view(
        template_name='account/password/reset_confirm_done.html'),
